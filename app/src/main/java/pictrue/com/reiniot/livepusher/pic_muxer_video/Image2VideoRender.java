...
public class Image2VideoRender implements EGLSurfaceView.GLRender {
    ...
    private Image2VideoFboRender wlImgFboRender;

    private int srcImg = 0;

    public Image2VideoRender(Context context) {
        this.context = context;

        wlImgFboRender = new Image2VideoFboRender(context);
