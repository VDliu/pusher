...
import pictrue.com.reiniot.livepusher.imgvideo.EglHelper;
import pictrue.com.reiniot.livepusher.imgvideo.WLEGLSurfaceView;

public abstract class WlBaseMediaEncoder {
    private static final String TAG = "WlBaseMediaEncoder";
