package pictrue.com.reiniot.livepusher.imgvideo;
...
public class ImageVideoActivity extends AppCompatActivity{
        ...
        wlMusic.setOnShowPcmDataListener(new OnShowPcmDataListener() {
            ...
            public void onPcmInfo(int samplerate, int bit, int channels) {
                ...
                wlMediaEncodec.initEncodec(wlImgVideoView.getEglContext(),
                        Environment.getExternalStorageDirectory().getAbsolutePath() + "/DCIM/wl_image_video.mp4",
    ...
    public void start(View view) {
        ...
        wlMusic.setSource(Environment.getExternalStorageDirectory().getAbsolutePath() + "/girl.m4a");
        wlMusic.prePared();
